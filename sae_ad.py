...
if __name__ == '__main__':
    ...
    dirs = '/home/chenjianxiao/EVOT/ad/sae/'+name+'/img/'
    ...
    while end_time <= T[-1]:
        ...
        if img_count == 1:
            number_1 = end_idx -start_idx#event number of the 1st pic
        number = end_idx -start_idx
        print(number_1)
        if number<number_1:
            flag = 1
            while flag:
                end_time = T[end_idx]+step_time
                slid_time = T[slid_idx]+step_time
                img_count += 1
                if end_time > T[-1]:
                    flag = 0
                while T[slid_idx] < slid_time:
